...
//保证json序列化json的时候，如果是null的对象，key也会消失
public class ServerResponse<T> implements Serializable {
    ...
    public static <T> ServerResponse<T> createByErrorCodeMessage(int error,String errrorMessage){
        return new ServerResponse<T>(error,errrorMessage);
    }
}
